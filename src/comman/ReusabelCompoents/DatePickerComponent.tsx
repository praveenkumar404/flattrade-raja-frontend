...
const DatePickerComponent: React.FC<DatePickerComponentProps> = ({ id, format, onChange }) => {
  const [selectedDate, setSelectedDate] = React.useState<Date | null>(new Date('2024-10-18T21:11:54'));
...
//     <Box>
//     <MuiPickersUtilsProvider utils={DateFnsUtils}>
//       <Grid container style={{backgroundColor:'#fff', borderRadius:'5px',width:'fit-content',padding:'5px'}}>
//         {selectedDate && (
//           <>
//             <KeyboardDatePicker
